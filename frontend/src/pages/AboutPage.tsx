      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '48px 40px' }}>
        ...
        <div style={{ marginBottom: '24px', backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '24px' }}>
          ...
          <div style={{ display: 'grid', gap: '12px' }}>
            {[
              { icon: '📅', title: 'ANC visit schedule', desc: 'Information about the recommended 8 antenatal care contacts and what happens at each visit.' },
              { icon: '🥦', title: 'Nutrition and supplements', desc: 'Guidance on eating well during pregnancy, and information about recommended supplements like iron and folic acid.' },
              { icon: '💆', title: 'Common pregnancy experiences', desc: 'Understanding nausea, back pain, fatigue, heartburn, and other normal pregnancy symptoms.' },
              { icon: '❓', title: 'Questions to ask your health worker', desc: 'Helping you prepare for your appointments with questions about your care.' },
              { icon: '🌍', title: 'Why ANC matters', desc: 'Explaining the importance of regular antenatal care for you and your baby.' },
            ].map(({ icon, title, desc }) => (
