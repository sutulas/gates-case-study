import { AlertOctagon, AlertTriangle, CheckCircle2, Heart, Check } from 'lucide-react'
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '48px 40px' }}>
        ...
        <div style={{ marginBottom: '24px', backgroundColor: '#FEF2F2', border: '2px solid #DC2626', borderRadius: '12px', padding: '20px 24px' }}>
          <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            <AlertOctagon size={24} style={{ color: '#DC2626', flexShrink: 0, marginTop: '2px' }} />
            <div>
        ...
        <div style={{ marginBottom: '24px', backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '24px' }}>
          ...
          <div style={{ display: 'grid', gap: '8px' }}>
            {normalSymptoms.map((item) => (
              <div key={item} style={{ display: 'flex', gap: '10px', padding: '10px 12px', borderRadius: '8px', backgroundColor: 'var(--color-primary-light)', fontSize: '14px', color: 'var(--color-text-secondary)', alignItems: 'center' }}>
        ...
        <div style={{ backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '24px' }}>
          <h2 style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '18px', fontWeight: '600', color: 'var(--color-text-primary)', marginBottom: '12px', marginTop: 0 }}>
            <Heart size={18} style={{ color: 'var(--color-primary)', flexShrink: 0 }} fill="currentColor" />
