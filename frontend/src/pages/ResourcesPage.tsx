    ...
    <div style={{ flex: 1, overflowY: 'auto', backgroundColor: 'var(--color-app-bg)' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '48px 40px' }}>
        ...
        <div style={{ marginBottom: '24px', backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '24px' }}>
          <h2 style={{ fontSize: '18px', fontWeight: '600', color: 'var(--color-text-primary)', marginBottom: '4px', marginTop: 0 }}>📅 The 8-Contact ANC Schedule</h2>
        ...
        {/* Nutrition */}
        <div style={{ marginBottom: '24px', backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '24px' }}>
          <h2 style={{ fontSize: '18px', fontWeight: '600', color: 'var(--color-text-primary)', marginBottom: '16px', marginTop: 0 }}>🥗 Nutrition During Pregnancy</h2>
          <div style={{ display: 'grid', gap: '10px' }}>
            {[
        ...
        <div style={{ backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '24px' }}>
          <h2 style={{ fontSize: '18px', fontWeight: '600', color: 'var(--color-text-primary)', marginBottom: '16px', marginTop: 0 }}>💬 Questions to Ask Your Health Worker</h2>
          <div style={{ display: 'grid', gap: '8px' }}>
            {[
              ...
              <div key={q} style={{ display: 'flex', gap: '10px', padding: '10px 12px', borderRadius: '8px', border: '1px solid var(--color-border)', fontSize: '14px', color: 'var(--color-text-secondary)' }}>
